...
import com.example.pimoscanner.location.DirectionsDialogFragment;
import com.example.pimoscanner.location.RoutingDialogFragment;
import com.example.pimoscanner.tools.Compas;
import com.example.pimoscanner.util.TaskExecutor;
 ...
 */
public class MapFragment extends Fragment implements BasemapsDialogFragment.BasemapsDialogListener, RoutingDialogFragment.RoutingDialogListener, DialogInterface.OnCancelListener {
...
//                setClickListenerForFloatingActionButton1(mMapView);
...
//    private void setClickListenerForFloatingActionButton1(final MapView mapView) {
//        final FloatingActionButton fab = mMapContainer.findViewById(R.id.fab1);
//        fab.setOnClickListener(new View.OnClickListener () {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(getActivity(), ActiveProjects.class);
...
//    }
    ...
    private void addCompass(int height) {
        ...
        // the MapView.
        mCompass = new Compas (mMapView.getContext());
        mCompass.setAlpha(1f);
        mCompass.setRotationAngle(45);
        int HEIGHT = 240;
        int WIDTH = 240;
        mCompassFrameParams = new FrameLayout.LayoutParams (WIDTH, HEIGHT, Gravity.RIGHT);
        ...
        ((ViewGroup.MarginLayoutParams) mCompassFrameParams).setMargins(LEFT_MARGIN_COMPASS, TOP_MARGIN_COMPASS,
